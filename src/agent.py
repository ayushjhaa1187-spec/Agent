...
class StockSenseAgent:
    ...
    def scan_inventory(self, inventory_file="data/sample_inventory.csv"):
        ...
        try:
            ...
            print(f"{self.logger_prefix} ERROR: Failed to scan inventory due to missing or invalid file.")
            return None
    ...
    def save_recommendations(self, recommendations, output_file="output/recommendations.json"):
        ...
        try:
            ...
            print(f"{self.logger_prefix} ERROR: Failed to save recommendations due to invalid file path.")
            return None
