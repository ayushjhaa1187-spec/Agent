...
class StockSenseAgent:
    ...
    def scan_inventory(self, inventory_file="data/sample_inventory.csv"):
        ...
        try:
            ...
            print(f"{self.logger_prefix} ERROR: Could not read inventory file. Access denied or file not found.")
            return None
    ...
    def save_recommendations(self, recommendations, output_file="output/recommendations.json"):
        ...
        try:
            ...
            print(f"{self.logger_prefix} ERROR: Could not save recommendations. Invalid output path.")
            return None
